-- Módulo de RH — formulário público em etapas (wizard)
-- form_fields.step agrupa as perguntas em telas — todas começam na etapa 1
-- (comportamento atual preservado); o admin reatribui pelo construtor.

ALTER TABLE form_fields ADD COLUMN step int NOT NULL DEFAULT 1 CHECK (step > 0);

-- CREATE OR REPLACE sobre a função das migrations anteriores — soma "step" no retorno.
