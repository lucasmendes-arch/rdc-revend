-- Adiciona compare_at_price ao retorno de get_top_sold_products
-- usado no portal para calcular preço sugerido de revenda (igual ao catálogo)
-- DROP necessário pois PostgreSQL não permite OR REPLACE com mudança de retorno
...
AS $$
  ...
  GROUP BY
    ...
    cp.id, cp.main_image, cp.price, cp.partner_price, cp.compare_at_price
