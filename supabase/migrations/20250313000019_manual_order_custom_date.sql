...
-- Adicionar p_created_at à create_manual_order para suportar datas retroativas
-- ============================================================================

DROP FUNCTION IF EXISTS public.create_manual_order(uuid,jsonb,numeric,text,text,text,text,numeric,uuid);
