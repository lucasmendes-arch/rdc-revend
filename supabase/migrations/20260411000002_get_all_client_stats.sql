-- ============================================================================
-- Migration: 20260411000002_get_all_client_stats.sql
-- RPC para listar todos os clientes (role='user') com estatísticas enriquecidas.
-- Usado pela aba "Clientes" em /admin/usuarios.
-- ============================================================================

CREATE OR REPLACE FUNCTION public.get_all_client_stats()
RETURNS TABLE (
  id                      uuid,
  full_name               text,
  phone                   text,
...
REVOKE EXECUTE ON FUNCTION public.get_all_client_stats() FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.get_all_client_stats() TO authenticated;
