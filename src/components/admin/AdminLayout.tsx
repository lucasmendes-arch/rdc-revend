...
import { Package, ShoppingCart, Users, Warehouse, UserCog, Menu, X, ExternalLink, Tag, Zap, DollarSign, GitBranch, Megaphone, UserCheck, History, BadgeDollarSign } from 'lucide-react'
